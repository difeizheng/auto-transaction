...
def test_v2_deep_optimization():
    ...
    test_configs = [
        # 基准：v2 止盈 35%
        {'name': 'v2 止盈 35% (基准)', 'threshold': 5.0, 'stop_loss': 0.04, 'trailing_trigger': 0.12},
        # 测试信号阈值
        {'name': '阈值 4.5', 'threshold': 4.5, 'stop_loss': 0.04, 'trailing_trigger': 0.12},
        {'name': '阈值 5.2', 'threshold': 5.2, 'stop_loss': 0.04, 'trailing_trigger': 0.12},
        # 测试止损
        {'name': '止损 3.5%', 'threshold': 5.0, 'stop_loss': 0.035, 'trailing_trigger': 0.12},
        {'name': '止损 4.5%', 'threshold': 5.0, 'stop_loss': 0.045, 'trailing_trigger': 0.12},
        # 测试移动止损触发点
        {'name': '移动 10% 触发', 'threshold': 5.0, 'stop_loss': 0.04, 'trailing_trigger': 0.10},
        {'name': '移动 15% 触发', 'threshold': 5.0, 'stop_loss': 0.04, 'trailing_trigger': 0.15},
        # 组合优化
        {'name': '组合 A (阈值 4.5+ 止损 3.5%)', 'threshold': 4.5, 'stop_loss': 0.035, 'trailing_trigger': 0.12},
        {'name': '组合 B (阈值 5.0+ 移动 10%)', 'threshold': 5.0, 'stop_loss': 0.04, 'trailing_trigger': 0.10},
        {'name': '组合 C (阈值 4.5+ 移动 10%)', 'threshold': 4.5, 'stop_loss': 0.04, 'trailing_trigger': 0.10},
        # 激进优化
        {'name': '激进 A (阈值 4.5+ 止损 3.5%+ 移动 10%)', 'threshold': 4.5, 'stop_loss': 0.035, 'trailing_trigger': 0.10},
        {'name': '激进 B (阈值 5.0+ 止损 3.5%+ 移动 12%)', 'threshold': 5.0, 'stop_loss': 0.035, 'trailing_trigger': 0.12},
    ]
