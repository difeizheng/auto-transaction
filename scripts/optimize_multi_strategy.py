...
def optimize_params():
    ...
    # 参数网格
    stop_loss_list = [0.04, 0.05, 0.06]
    take_profit_list = [0.25, 0.30, 0.35]
    ...
    # 保存结果
    df.to_csv('data/cache/param_optimization_v3.csv', index=False)
    print(f"\n结果已保存至：data/cache/param_optimization_v3.csv")
